...
#Guardamos en csv
pandasRes.to_csv("WorldWitoutUSA-Negative-NoRep-" + time.strftime("%c") + "-semicolon"  + ".csv", sep = ';')
pandasRes.to_csv("WorldWitoutUSA-Negative-NoRep-" + time.strftime("%c") +"-comma" + ".csv", sep = ',')
