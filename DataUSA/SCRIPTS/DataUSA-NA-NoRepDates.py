...
#Poner NaN los valores negativos
...
#Guardamos en csv
pandasRes.to_csv("US-NaN-NoRep-" + time.strftime("%c") + "-semicolon"  + ".csv", sep = ';')
pandasRes.to_csv("US-NaN-NoRep-" + time.strftime("%c") +"-comma" + ".csv", sep = ',')
