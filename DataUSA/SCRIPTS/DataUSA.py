...
#pandasRet.loc[((pandasRet['Country_Region'] == pandasRet['Country_Region'].shift(1)) & ((pandasRet['Province_State'] == pandasRet['Province_State'].shift(1)) | (pandasRet['Province_State'] == "")) & (pandasRet['Confirmed'] <= pandasRet['Confirmed'].shift(1)) ) , 'Confirmed'] = np.NaN
...
#pandasRet.loc[((pandasRet['Country_Region'] == pandasRet['Country_Region'].shift(1)) & ((pandasRet['Province_State'] == pandasRet['Province_State'].shift(1)) | (pandasRet['Province_State'] == "")) & (pandasRet['Deaths'] <= pandasRet['Deaths'].shift(1)) ) , 'Deaths'] = np.NaN
...
#pandasRet.loc[((pandasRet['Country_Region'] == pandasRet['Country_Region'].shift(1)) & ((pandasRet['Province_State'] == pandasRet['Province_State'].shift(1)) | (pandasRet['Province_State'] == "")) & (pandasRet['Recovered'] <= pandasRet['Recovered'].shift(1)) ) , 'Recovered'] = np.NaN
...
#pandasRes.loc[(pandasRet['Recovered']) < pandasRet['Recovered'].shift(1), 'Recovered' ] = np.NaN
...
#pandasRes.loc[(pandasRet['Deaths']) < pandasRet['Deaths'].shift(1), 'Deaths' ] = np.NaN
...
#pandasRes.loc[(pandasRet['Confirmed']) < pandasRet['Confirmed'].shift(1), 'Confirmed' ] = np.NaN
...
#Guardamos en csv
pandasRes.to_csv("US-Pad-" + time.strftime("%c") + "-semicolon"  + ".csv", sep = ';')
pandasRes.to_csv("US-Pad-" + time.strftime("%c") +"-comma" + ".csv", sep = ',')
